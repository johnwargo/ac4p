...
sap.ui.table.AnalyticalColumnMenu.prototype._addGroupMenuItem=function(){var c=this._oColumn,t=this._oTable,b=t.getBinding("rows"),r=b&&b.getAnalyticalQueryResult();if(t&&r&&r.findDimensionByPropertyName(c.getLeadingProperty())){this._oGroupIcon=this._createMenuItem("group","TBL_GROUP",c.getGrouped()?"accept":null,jQuery.proxy(function(e){var m=e.getSource(),g=c.getGrouped();c.setGrouped(!g);m.setIcon(!g?"sap-icon://accept":null)},this));this.addItem(this._oGroupIcon)}};
